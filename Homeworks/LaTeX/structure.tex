...
\lstdefinelanguage{Python3}{
  ...
  morekeywords=[3]{
    ...
    EOFError, FloatingPointError, GeneratorExit, ImportError, IndexError,
    ...
    SystemExit, TypeError, UnboundLocalError, UnicodeError, ValueError,
    ZeroDivisionError,
  },
  basicstyle=\ttfamily\small\color{black},
  keywordstyle=\color{purple}\bfseries,          % keywords (def, if, for, etc.)
  keywordstyle=[2]\color{blue}\bfseries,         % built-in functions
  keywordstyle=[3]\color{red}\bfseries,          % exceptions
  commentstyle=\color{teal}\itshape,             % comments
  stringstyle=\color{orange},                     % strings
  identifierstyle=\color{black},                  % normal identifiers
  emphstyle=\color{violet}\bfseries,              % emphasized words
  numbers=left,
  numberstyle=\small\color{gray},
  stepnumber=1,
  numbersep=4pt,
